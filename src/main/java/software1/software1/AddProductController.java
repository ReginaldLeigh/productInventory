...
/**
 * Controls actions and behavior of the Add Product user form.
 * Allows user to create new products and add them to the program's inventory.
 */
public class AddProductController implements Initializable {
    ...
    /**
     * Clears all data from the associated parts and sets Table View with all parts in the Inventory prior to displaying the page.
     */
    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        associatedParts.removeAll();
        setAllPartTableView(Inventory.getAllParts());
        setAssocPartTableView(associatedParts);
    }
}
